...
public class UserManagementServicesMainServelet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	Logger logger = Logger.getLogger(UserManagementServicesMainServelet.class
			.getName());
	UserManagementServiceHttpRequestHandler requestHandler = new UserManagementServiceHttpRequestHandler();
