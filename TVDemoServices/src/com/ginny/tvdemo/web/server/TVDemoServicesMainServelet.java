...
public class TVDemoServicesMainServelet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	Logger logger = Logger
			.getLogger(TVDemoServicesMainServelet.class.getName());
	TVDemoServiceHttpRequestHandler requestHandler = new TVDemoServiceHttpRequestHandler();
	...
	private void handle(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (taskUri != null && taskUri.startsWith("/tvdemo")) {
