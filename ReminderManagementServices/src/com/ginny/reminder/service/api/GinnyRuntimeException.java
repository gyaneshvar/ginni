...
public class GinnyRuntimeException extends RuntimeException {
	...
	public static final String ERROR_CODE_REMINDER_MANAGEMENT_SERVICE_ERROR = "REMINDER_MANAGEMENT_SERVICE_ERROR";
	public static final String ERROR_CODE_REMINDER_MANAGEMENT_SERVICE_ERROR_DESC = "User management service encountered error";
