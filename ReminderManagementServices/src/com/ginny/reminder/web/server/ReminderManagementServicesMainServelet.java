...
public class ReminderManagementServicesMainServelet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	Logger logger = Logger.getLogger(ReminderManagementServicesMainServelet.class
			.getName());
	ReminderManagementServiceHttpRequestHandler requestHandler = new ReminderManagementServiceHttpRequestHandler();
