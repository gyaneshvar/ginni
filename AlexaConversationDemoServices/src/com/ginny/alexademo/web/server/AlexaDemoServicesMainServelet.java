...
public class AlexaDemoServicesMainServelet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	Logger logger = Logger.getLogger(AlexaDemoServicesMainServelet.class
			.getName());
	AlexaDemoServicesHttpRequestHandler requestHandler = new AlexaDemoServicesHttpRequestHandler();
	...
	private void handle(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (taskUri != null && taskUri.startsWith("/alexademo")) {
